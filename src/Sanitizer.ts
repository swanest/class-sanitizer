...
export class Sanitizer {
     ...
     */
    normalizeEmail(str: string, options?: NormalizeEmailOptions): string | false {
        return validator.normalizeEmail(str, options);
    }
    ...
    sanitize(object: any) {
        this.metadataStorage
            ...
            .filter(metadata => {
                return object[metadata.propertyName] !== undefined;
            })
            .forEach(
                metadata =>
